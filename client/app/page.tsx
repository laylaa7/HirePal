...
export default function HirePalChat() {
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="flex space-x-3 w-full">
              <Button
                ...
                className="flex-1 border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300 transition-all duration-200 py-3 font-semibold shadow-sm hover:shadow-md group"
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 relative overflow-hidden">
